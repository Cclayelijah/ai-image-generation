      ...
      <section className="mx-auto bg-white dark:bg-gray-900">
        <div className="max-w-screen-md px-4 py-8 mx-auto lg:py-16">
          ...
          <p className="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">
            Got a technical issue? Want to send feedback about a feature? Have
            questions about how we handle your data? Let us know.
          </p>
          <form action="#" className="space-y-8">
            ...
            <button
              type="submit"
              className="px-5 py-3 text-sm font-medium text-center text-white bg-black rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
            >
              Send message
            </button>
          </form>
